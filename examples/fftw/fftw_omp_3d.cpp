...
int main(int argc, char *argv[])
{
    ...
    plan_info_file.open("plans/plan_fftw_omp_3d.txt", std::ios_base::app);
    ...
    FILE *plan_file = fopen("plans/plan_fftw_omp_3d.txt", "a");
